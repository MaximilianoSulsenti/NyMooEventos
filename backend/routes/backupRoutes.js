...
const { runBackup, downloadBackup } = require('../controllers/backupController');
...
// Solo el equipo de NyMoo puede descargar el último backup.
router.get('/download', requireAuth, requireAdmin, downloadBackup);
