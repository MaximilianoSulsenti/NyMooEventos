...
export const FONT_FAMILY_CLASSES = {
  ...
  bebas: 'font-bebas',
  chewy: 'font-chewy',
  hennypenny: 'font-hennypenny',
  rubikspraypaint: 'font-rubikspraypaint',
  barriecito: 'font-barriecito',
  festive: 'font-festive',
  luxuriousscript: 'font-luxuriousscript',
  monoton: 'font-monoton',
  kablammo: 'font-kablammo',
  akronim: 'font-akronim',
  nabla: 'font-nabla',
  honk: 'font-honk',
  agudisplay: 'font-agudisplay',
  rubikmoonrocks: 'font-rubikmoonrocks',
  rubikvinyl: 'font-rubikvinyl',
  rubikdistressed: 'font-rubikdistressed',
