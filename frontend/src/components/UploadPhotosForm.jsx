...
function UploadPhotosForm({ eventSlug, primaryColor = '#a855f7' }) {
  ...
  return (
    <div className="flex flex-col items-center gap-4 text-white">
      ...
      <textarea
        ...
        maxLength={60}
        rows={2}
        className="w-full max-w-sm rounded-lg bg-neutral-800 border border-white/10 px-3 py-2 text-sm outline-none transition-colors focus:border-purple-500 focus:ring-2 focus:ring-purple-500/40"
      />
